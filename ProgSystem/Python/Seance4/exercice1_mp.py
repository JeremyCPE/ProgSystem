...
if __name__ == "__main__" :
    ...
    while True :      
        ...
        p1 = Process(target=tache_capteur_temperature , args=())
        p2 = Process(target=tache_capteur_pression , args=())
        p3 = Process(target=tache_controleur_central , args=())
        p4 = Process(target=tache_screen , args=())
        mesProcess.append(p1)
        mesProcess.append(p2)
        mesProcess.append(p3)
        mesProcess.append(p4)
